...
The plugin can be configured through the WordPress admin panel under the YMM menu.
...
- Category field visibility issues after search
- Hardcoded category exclusions need admin interface
